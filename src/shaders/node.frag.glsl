// Fragment shader for ethereal bioluminescent nodes
uniform float uTime;
...
void main() {
  ...
  // Alpha based on biography weight for more prominent nodes
